...
def test_forgot_password_page(browser):
    """Проверка восстановления пароля по почте - негативные сценарии (8 сценариев).
    ...
    time.sleep(25)     # время на ввод капчи
    ...
    def input_new_pass(new_pass):
        # browser.find_element(*NewPassLocators.NEWPASS_NEW_PASS).clear() - не работает!!!
